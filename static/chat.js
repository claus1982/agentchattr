...
const BRAND_AVATARS = {
    ...
    kilo: `<svg viewBox="0 0 16 16" fill="white"><text x="50%" y="50%" dominant-baseline="central" text-anchor="middle" font-size="12" font-weight="bold" font-family="system-ui,sans-serif">K</text></svg>`,
};
